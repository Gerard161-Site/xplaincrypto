...
class TokenInfoExtractor:
    ...
    def _search_for_whitepaper(self, project_name: str) -> Optional[str]:
        ...
        try:
            ...
            if project_name.lower() == "ondo":
                self.logger.info("Using known documentation URL for Ondo")
                return "https://docs.ondo.foundation/ondo-token"
            ...
            whitepaper_indicators = ["whitepaper", "white-paper", "white paper", "technical", "docs", "documentation", "tokenomics"]
    ...
    def _extract_from_url(self, project_name: str, doc_url: str, query_type: str = "distribution") -> Dict[str, Any]:
        ...
        """
        try:
            # Handle Ondo Foundation docs
            if "docs.ondo.foundation" in doc_url:
            ...
            # elif "docs.solana.com" in doc_url:
    ...
    def _extract_ondo_data(self, doc_url: str, query_type: str) -> Dict[str, Any]:
        ...
        if query_type == "distribution":
            try:
                ...
                # This is hardcoded based on current Ondo docs structure
                ...
                ondo_data = {
                    ...
                    "sources": [
                        {
                            "title": "Ondo Foundation Docs - ONDO Token",
                            "url": "https://docs.ondo.foundation/ondo-token"
                        }
                    ],
                ...
                self.logger.error(f"Error extracting from Ondo docs: {str(e)}")
                return None
